import{a7 as r,a8 as s,a9 as y}from"./index-DJvBEpmM.js";const i={tpl_din_wiring:`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 660 380" font-family="'Microsoft YaHei',sans-serif">
...
</svg>`},n={tpl_din_wiring:"DIN插头接线",tpl_plc_sinking:"PLC漏型输出",tpl_relay_diode:"继电器隔离+续流",tpl_sensor_3wire_plc:"3线传感器接PLC",tpl_sensor_2wire_plc:"2线磁感接PLC",tpl_npn_pnp_relay:"NPN/PNP继电器转换",tpl_wire_color_legend:"导线颜色图例",tpl_plc_io_common:"PLC公共端源漏型",tpl_stepper_driver:"步进驱动接线",tpl_servo_driver:"伺服驱动接线",tpl_vfd_wiring:"变频器接线",tpl_motor_fwd_rev:"正反转互锁",tpl_motor_stardelta:"星三角启动",tpl_socket_wiring:"插座接线",tpl_crystal_head:"RJ45线序"};function f(e){if(typeof e!="string"||!e)return null;const t=e.split("|");return i[t[0]]?{id:t[0],params:t.slice(1)}:null}function h(e){const t=f(e);if(!t)return null;let x=i[t.id];return t.params.forEach((o,l)=>{x=x.split("{{"+(l+1)+"}}").join(o)}),x}function d(e){const t=h(e);return t?"data:image/svg+xml;base64,"+btoa(unescape(encodeURIComponent(t))):null}function c(e){if(typeof e!="string"||!e)return null;if(e.split("|")[0].startsWith("file:ill/")){const t=r(e);return t?"/quiz-platform/img/ill/"+t:null}return d(e)}function w(e){if(typeof e=="string"&&e.split("|")[0].startsWith("file:ill/"))return y(e)||"题目配图";const t=f(e);return t?n[t.id]||t.id:""}function a(e){return s(e).map(t=>({src:c(t),title:w(t)})).filter(t=>t.src)}export{a,c as d};
