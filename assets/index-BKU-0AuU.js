import{a7 as r,a8 as s}from"./index-acmlxdAz.js";const i={tpl_din_wiring:`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 660 380" font-family="'Microsoft YaHei',sans-serif">
...
</svg>`},y={tpl_din_wiring:"DIN插头接线",tpl_plc_sinking:"PLC漏型输出",tpl_relay_diode:"继电器隔离+续流",tpl_sensor_3wire_plc:"3线传感器接PLC",tpl_sensor_2wire_plc:"2线磁感接PLC",tpl_npn_pnp_relay:"NPN/PNP继电器转换",tpl_wire_color_legend:"导线颜色图例",tpl_plc_io_common:"PLC公共端源漏型",tpl_stepper_driver:"步进驱动接线",tpl_servo_driver:"伺服驱动接线",tpl_vfd_wiring:"变频器接线",tpl_motor_fwd_rev:"正反转互锁",tpl_motor_stardelta:"星三角启动",tpl_socket_wiring:"插座接线",tpl_crystal_head:"RJ45线序"};function f(t){if(typeof t!="string"||!t)return null;const e=t.split("|");return i[e[0]]?{id:e[0],params:e.slice(1)}:null}function n(t){const e=f(t);if(!e)return null;let x=i[e.id];return e.params.forEach((o,l)=>{x=x.split("{{"+(l+1)+"}}").join(o)}),x}function h(t){const e=n(t);return e?"data:image/svg+xml;base64,"+btoa(unescape(encodeURIComponent(e))):null}function c(t){if(typeof t!="string"||!t)return null;if(t.split("|")[0].startsWith("file:ill/")){const e=r(t);return e?"/quiz-platform/img/ill/"+e:null}return h(t)}function w(t){if(typeof t=="string"&&t.split("|")[0].startsWith("file:ill/"))return s(t)||"题目配图";const e=f(t);return e?y[e.id]||e.id:""}export{w as a,c as d};
