...
--   2) 取教师账号 UUID 并全文件替换 06006dc2-2df7-4a1e-9bf1-84fd7692a7dd：
...
-- ── 6. 教师账号全权策略（唯一写入口；执行前替换 06006dc2-2df7-4a1e-9bf1-84fd7692a7dd）──
CREATE POLICY owner_all_attributes
  ON public.attributes FOR ALL TO authenticated
  USING (auth.uid() = '06006dc2-2df7-4a1e-9bf1-84fd7692a7dd')
  WITH CHECK (auth.uid() = '06006dc2-2df7-4a1e-9bf1-84fd7692a7dd');
