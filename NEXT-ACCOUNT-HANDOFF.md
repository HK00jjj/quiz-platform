...
- gh-pages HEAD **`7254df3`**（链：… §39 `f5f4e6f` → §40 `96af8f2` → §41 `b93e18f` 撤回§40 → §42 `7254df3` 撤回彩旗串）。src 分支与 gh-pages 同步（回读零差异，含 NEXT-ACCOUNT-HANDOFF.md）。verify-live ALL OK。
