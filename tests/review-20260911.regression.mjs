/* 2026-09-11 全量审查整改 · 回归锁
   ...
   ⚠ 未能覆盖的部分（诚实声明）：考试续考上界判定（Learns.jsx 组件内）、离线待补传队列
   （store.js 依赖 supabase client，Node 直跑需 mock），二者靠人工真机验证。 */
...
const { normText, normId, hashId, dropNormalizedDupes } = await import(url('lib/validate.js'))
